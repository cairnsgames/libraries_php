...
$EVENT_FIELDS = ['id', 'calendar_id', 'user_id', 'event_template_id', 'content_id', 'app_id', 'title', 'description', 'currency', 'price', 'image', 'keywords', 'event_type', 'duration', 'location', 'lat', 'lng', 'max_participants', 'periodType', 'tickettypes', 'options', 'start_time', 'end_time', 'show_as_news', 'overlay_text','enable_bookings'];
...
$klokoconfigs = [
    ...
    "event" => [
        'tablename' => 'kloko_event',
        'key' => 'id',
        'select' => ['id', 'calendar_id', 'user_id', 'event_template_id', 'content_id', 'app_id', 'title', 'description', 'currency', 'price', 'image', 'keywords', 'event_type', 'duration', 'location', 'lat', 'lng', 'max_participants', 'start_time', 'end_time', 'periodType', 'tickettypes', 'options', 'show_as_news', 'overlay_text','enable_bookings'],
        'create' => ['calendar_id', 'user_id', 'event_template_id', 'content_id', 'app_id', 'title', 'description', 'currency', 'price', 'image', 'keywords', 'event_type', 'duration', 'location', 'lat', 'lng', 'max_participants', 'start_time', 'end_time','periodType', 'tickettypes', 'options', 'show_as_news', 'overlay_text','enable_bookings'],
        'update' => ['title', 'description', 'currency', 'price', 'image', 'content_id', 'keywords', 'event_type', 'duration', 'location', 'lat', 'lng', 'max_participants', 'start_time', 'end_time','periodType', 'tickettypes', 'options', 'show_as_news', 'overlay_text','enable_bookings'],
        'delete' => true,
        'beforeselect' => '',
        'afterselect' => '',
