...
$breezoconfigs = [
    ...
    "user" => [
        'tablename' => 'user',
        'key' => 'id',
        'select' => ['id', 'firstname', 'lastname', 'email', 'created', 'modified'],
        'beforeselect' => '',
        'afterselect' => '',
        'subkeys' => [
            'cart' => [
            ...
            'orders' => [
                ...
                'key' => 'user_id',
                'select' => ['id', 'user_id', 'status', 'total_price', 'created', 'modified'],
                'beforeselect' => '',
                'afterselect' => ''
            ],
            'invoices' => [
    ...
    "supplier" => [
        ...
        'subkeys' => [
            ...
            'items' => [
                ...
                'key' => 'supplier_id',
                'select' => ['id', 'cart_id', 'item_type_id', 'item_id', 'supplier_id', 'price', 'quantity', 'commission_rate', 'booking_id', 'created', 'modified'],
                'beforeselect' => '',
                'afterselect' => ''
            ]
        ]
    ...
    "order" => [
        ...
        'key' => 'id',
        'select' => ['id', 'user_id', 'status', 'total_price', 'created', 'modified'],
        'create' => ['user_id', 'status', 'total_price'],
        'update' => ['status', 'total_price'],
        'delete' => true,
        'beforeselect' => '',
        'afterselect' => '',
        'beforecreate' => '',
        ...
        'subkeys' => [
            'order_items' => [
                ...
                'key' => 'order_id',
                'select' => ['id', 'order_id', 'item_type_id', 'item_id', 'supplier_id', 'price', 'quantity', 'commission_rate', 'booking_id', 'created', 'modified'],
                'beforeselect' => '',
                'afterselect' => ''
            ]
        ]
    ...
    "cart_item" => [
        ...
        'key' => 'id',
        'select' => ['id', 'cart_id', 'item_type_id', 'item_id', 'supplier_id', 'price', 'quantity', 'commission_rate', 'booking_id', 'created', 'modified'],
        'create' => ['cart_id', 'item_type_id', 'item_id', 'supplier_id', 'price', 'quantity', 'commission_rate', 'booking_id'],
        'update' => ['price', 'quantity', 'commission_rate', 'booking_id'],
        'delete' => true,
        'beforeselect' => '',
        'afterselect' => '',
    ...
    "order_item" => [
        ...
        'key' => 'id',
        'select' => ['id', 'order_id', 'item_type_id', 'item_id', 'supplier_id', 'price', 'quantity', 'commission_rate', 'booking_id', 'created', 'modified'],
        'create' => ['order_id', 'item_type_id', 'item_id', 'supplier_id', 'price', 'quantity', 'commission_rate', 'booking_id'],
        'update' => ['price', 'quantity', 'commission_rate', 'booking_id'],
        'delete' => true,
        'beforeselect' => '',
        'afterselect' => '',
